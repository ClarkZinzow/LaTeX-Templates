...
%  NOTE:  Remove this package when using template!  This generates dummy text.
...
\newcommand{\institutionName}{University of Wisconsin-Madison}  % University.
\newcommand{\lastmodified}{\today}  % Date last modified.
