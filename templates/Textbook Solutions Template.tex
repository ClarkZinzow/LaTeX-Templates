% Basic textbook solutions template.
%
% By Clark Zinzow
...
\newcommand{\bookName}{Introduction to Advanced Intermediate: For Beginning Experts}  % Book name.
...
\newcommand{\bookAuthor}{Writey McAuthorface}  % Book author's name.
...
%	\end{titlepage}
	...
	\makeatother
	%  If you don't want a list of todos table of contents page, comment out
	%  the line below.
	\listoftodos\relax
